    ...
    if request.method == 'POST':
        try:
            if request.session['user']:
                ...
                # อ้างอิง : https://www.sanook.com/health/26821/
                if int(age[0]) <= 17:
                    request.session['who'] = "ควรออกกำลังกายปานกลางถึงหนัก อย่างน้อย 60 นาทีต่อสัปดาห์"
                elif int(age[0]) >= 18 and int(age[0]) <= 64:
                    request.session['who'] = "ควรออกกำลังกายอย่างน้อย 150 นาที หรือ 2.5 ชั่วโมงจ่อสัปดาห์"
                elif int(age[0]) >= 65:
                ...
                # อ้างอิง : https://women.trueid.net/detail/QNMAA4vJgJpN
                if sex[0] == "female":
                    if int(age[0]) >= 19 and int(age[0]) <= 30:
                        age_e = "19 - 30"
                        should_eat = 2200
                    elif int(age[0]) >= 31 and int(age[0]) <= 59:
                        age_e = "31 - 59"
                        should_eat = 2000
                    elif int(age[0]) > 60:
                        age_e = "> 60"
...
def choose_three(request):
    ...
    print(m_1, m_2, m_3, f_1, f_2, f_3)
    return render(request, 'belly/choose_three.html', {"m1": m_1, "m2": m_2, "m3": m_3, "f1": f_1, "f2": f_2, "f3": f_3})
